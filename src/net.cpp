...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("NefariousCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("NefariousCoin-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("NefariousCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("NefariousCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("NefariousCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("NefariousCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NefariousCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("NefariousCoin-start");
