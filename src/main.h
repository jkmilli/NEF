...
static const uint256 hashGenesisBlock("0x00000c786570d79bc1dc2e2383755a22b09656fa89fee736e1f63bace75074f3");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((8.33 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at NefariousCoin block #0
        ...
        // Before NefariousCoin block #0 - get from pregenerated table
