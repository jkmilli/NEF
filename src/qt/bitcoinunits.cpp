...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NefariousCoins"));
    case mBTC: return QString(QObject::tr("Milli-NefariousCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NefariousCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
